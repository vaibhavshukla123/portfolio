...
const projects = [{
        ...
        description: 'Attendance of students/employees is taken using Face recognition (Machine learning) .',
        tags: [{
                name: 'react',
    ...
    },
    {
        ...
        description: 'Farmers can sell thier products by showing details of agro products to customers.',
        tags: [{
                name: 'react',
                color: 'blue-text-gradient',
            },
    ...
    },
    {
        id: 'project-5',
        name: 'Restauranter',
        description: 'This is a Restaurant website for managing all the operations.',
        tags: [{
                name: 'nextjs',
                color: 'blue-text-gradient',
            },
        ...
        // image: nyeusi,
        image: restauranter,
        repo: 'https://restauranter.w3spaces.com/',
        demo: 'https://restauranter.w3spaces.com/',
    },
];
